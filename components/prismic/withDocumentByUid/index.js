...
export default function withDocumentById(_ref) {
  var url = _ref.url,
  ...
  return function (ComposedComponent) {
    return function (_React$Component) {
      _inherits(withDocument, _React$Component);

      function withDocument(props) {
        ...
        _this2.componentDidMount = function () {
          var _this = _this2;
          queryByUid({ url: url, apiOptions: apiOptions, uid: uid, type: type }).then(function (response) {
      ...
      withDocument.prototype.render = function render() {
        var _prismic;
